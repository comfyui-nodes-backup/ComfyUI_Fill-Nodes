...
logger = logging.getLogger("fl_fill_nodes.minimax_music3_loader")
...
def _download_url(artifact):
    return f"https://huggingface.co/{REPO_ID}/resolve/{REPO_REVISION}/{artifact['repo_path']}?download=true"
...
def _ensure_artifacts(unique_id=None, status=None):
